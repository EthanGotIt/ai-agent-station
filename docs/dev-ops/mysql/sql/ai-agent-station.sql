...
--
-- Dumping data for table `ai_client_api`
--
...
--
-- Dumping data for table `ai_client_rag_order`
--
...
CREATE TABLE `ai_client_tool_mcp` (
  ...
  `transport_type` varchar(20) NOT NULL COMMENT '传输类型(stdio/streamable_http)',
  `transport_config` varchar(1024) DEFAULT NULL COMMENT '传输配置(stdio/streamable_http)',
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='MCP客户端配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ai_client_tool_mcp` (`id`, `mcp_id`, `mcp_name`, `transport_type`, `transport_config`, `request_timeout`,
    `status`, `create_time`, `update_time`)
    VALUES (1, '5001', 'rednote', 'stdio',
    '{\n    "rednote": {\n        "command": "npx.cmd",\n        "args": [\n          "rednote-mcp",\n          "--stdio"\n        ]\n    }\n}',
    180, 1, '2026-03-26 20:45:58', '2026-03-26 20:45:58'),
    (2, '5002', 'notify', 'stdio',
    '{\n    \"notify\": {\n        \"command\": \"npx.cmd\",\n        \"args\": [\"-y\", \"@6starlong/mcp-server-notify\"]\n    }\n}',
    180, 1, '2026-03-26 19:24:57', '2026-03-26 19:26:09'),
    (3, '5003', 'file-system', 'stdio',
    '{\n    \"filesystem\": {\n        \"command\": \"npx.cmd\",\n        \"args\": [\n            \"-y\",\n            \"@modelcontextprotocol/server-filesystem\",\n            \"C:/Users/23260/Desktop\",\n            \"D:/FileSystemMcp\"\n        ]\n    }\n}',
    180, 1, '2025-06-14 12:36:30', '2026-03-21 18:21:15'),
    (4, '5004', 'g-search', 'stdio',
    '{\n    \"g-search\": {\n        \"command\": \"npx.cmd\",\n        \"args\": [\n            \"-y\",\n            \"g-search-mcp\"\n        ]\n    }\n}',
    180, 1, '2025-06-14 12:36:30', '2026-03-21 18:21:15'),
    (5, '5005', 'baidu-map', 'streamable_http',
    '{\n	\"baseUri\":\"https://mcp.map.baidu.com\",\n	\"endpoint\":\"/mcp?ak=XbXjKkyN2JyOAUd5KL6lDThpzvRnaAVu\"\n}',
    180, 1, '2025-06-14 12:36:30', '2026-03-23 23:07:33'),
    (6, '5006', 'baidu-search', 'streamable_http',
    '{\n	\"baseUri\":\"https://qianfan.baidubce.com/v2/ai_search/mcp\",\n	\"headers\":{\"Authorization\":\"Bearer bce-v3/ALTAK-uc6IPvLYyvrHdDEAlrzCC/8ce1b63e601857d4914b91c3b43a89d95844f83a\"}\n}',
    180, 1, '2025-06-14 12:36:30', '2026-03-25 16:02:01'),
    (7, '5007', 'elasticsearch', 'stdio',
    '{\n    \"elasticsearch\": {\n      \"command\": \"npx.cmd\",\n      \"args\": [\n        \"-y\",\n        \"@awesome-ai/elasticsearch-mcp\"\n      ],\n      \"env\": {\n        \"ES_HOST\": \"http://127.0.0.1:9200\",\n        \"ES_API_KEY\": \"your-api-key\",\n        \"OTEL_SDK_DISABLED\":\"true\",\n        \"NODE_OPTIONS\":\"--no-warnings\"\n      }\n    }\n}',
    180, 1, '2025-06-14 12:36:30', '2025-08-09 14:12:22'),
    (8, '5008', 'grafana', 'stdio',
    '{\n    \"grafana\": {\n      \"command\": \"docker\",\n      \"args\": [\n        \"run\",\n        \"--rm\",\n        \"-i\",\n        \"-e\",\n        \"GRAFANA_URL\",\n        \"-e\",\n        \"GRAFANA_API_KEY\",\n        \"mcp/grafana\",\n        \"-t\",\n        \"stdio\"\n      ],\n      \"env\": {\n        \"GRAFANA_URL\": \"http://127.0.0.1:4000\",\n        \"GRAFANA_API_KEY\": \"glsa_IObTIVBoma3KsCmse8V9iNRDeZrV1L99_cab3b0b0\"\n      }\n    }',
...
CREATE TABLE `ai_client_model` (
  ...
  KEY `idx_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='聊天模型配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES
    ...
    (62,'client','2102','model','2001','\"\"',1,'2025-06-14 12:46:49','2025-08-17 12:44:47'),
...
-- Dump completed on 2026-03-26 20:50:02

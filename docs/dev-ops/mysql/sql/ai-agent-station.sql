...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: ai_agent
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: ai_agent_flow_config
# ------------------------------------------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '智能体-客户端关联表';

# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: ai_agent_task_schedule
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: ai_client
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: ai_client_advisor
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: ai_client_api
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: ai_client_config
# ------------------------------------------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 22 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI客户端统一关联配置表';

# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: ai_client_model
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: ai_client_rag_order
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: ai_client_system_prompt
# ------------------------------------------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '系统提示词配置表';

# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: ai_client_tool_mcp
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: ai_agent_flow_config
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: ai_agent_task_schedule
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: ai_client_advisor
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: ai_client_api
# ------------------------------------------------------------
...
VALUES
  (
    ...
    'sk-0ec8457a16644d5ca60a3468b20463e2',
    'v1/chat/completions',
    'v1/embeddings',
    1,
    '2025-06-14 12:33:22',
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: ai_client_config
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: ai_client_model
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: ai_client_rag_order
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: ai_client_system_prompt
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: ai_client_tool_mcp
# ------------------------------------------------------------

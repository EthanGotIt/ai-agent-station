...
INSERT INTO `ai_agent` (`id`, `agent_id`, `agent_name`, `description`, `channel`, `status`, `create_time`,
                        `update_time`)
VALUES (6, '1', '自动发帖服务', 'CSDN自动发帖，微信公众号通知。', 'agent', 1, '2025-06-14 12:41:20',
        '2025-06-14 12:41:20'),
...
VALUES
    (1,'1','3001','通用','DEFAULT',1,NULL,'2025-06-14 12:42:20'),
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AI客户端配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES
    ...
    (2,'3002','自动发帖和通知','自动生成CSDN文章，发送微信公众号消息通知',1,'2025-06-14 12:43:02','2025-06-14 12:43:02'),
    (3,'3003','文件操作服务','文件操作服务',1,'2025-06-14 12:43:02','2025-06-14 12:43:02'),
    (4,'3004','流式对话客户端','流式对话客户端',1,'2025-06-14 12:43:02','2025-06-14 12:43:02'),
    (5,'3005','地图','地图',1,'2025-06-14 12:43:02','2025-06-14 12:43:02'),
    (6,'3101','任务分析和状态判断','你是一个专业的任务分析师，名叫 AutoAgent Task Analyzer。',1,'2025-06-14 12:43:02','2025-07-27 17:00:55'),
    (7,'3102','具体任务执行','你是一个精准任务执行器，名叫 AutoAgent Precision Executor。',1,'2025-06-14 12:43:02','2025-07-27 17:01:10'),
    (8,'3103','质量检查和优化','你是一个专业的质量监督员，名叫 AutoAgent Quality Supervisor。',1,'2025-06-14 12:43:02','2025-07-27 17:01:23'),
    (9,'3104','负责响应式处理','你是一个智能响应助手，名叫 AutoAgent React。',1,'2025-06-14 12:43:02','2025-08-07 14:16:47'),
    (10,'4101','任务分析和状态判断','你是一个专业的任务分析师，名叫 AutoAgent Task Analyzer。',1,'2025-06-14 12:43:02','2025-07-27 17:00:55'),
    (11,'4102','具体任务执行','你是一个精准任务执行器，名叫 AutoAgent Precision Executor。',1,'2025-06-14 12:43:02','2025-07-27 17:01:10'),
    (12,'4103','质量检查和优化','你是一个专业的质量监督员，名叫 AutoAgent Quality Supervisor。',1,'2025-06-14 12:43:02','2025-07-27 17:01:23'),
    (13,'4104','负责响应式处理','你是一个智能响应助手，名叫 AutoAgent React。',1,'2025-06-14 12:43:02','2025-08-07 14:16:47');
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AI客户端统一关联配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ai_client_model` (`id`, `model_id`, `api_id`, `model_name`, `model_type`, `status`, `create_time`,
                               `update_time`)
VALUES (1, '2001', '1001', 'qwen3.5-plus', 'openai', 1, '2025-06-14 12:33:47', '2026-03-21 18:11:25'),
       (2,'2002','1001','glm-5','openai',1,'2025-06-14 12:33:47','2025-08-09 10:36:53'),
       (3,'2003','1001','deepseek-v3.2','openai',1,'2025-06-14 12:33:47','2025-08-09 10:36:53');
...
VALUES (8, '5003', 'file-system', 'stdio',
       ...
       (11, '5006', 'baidu-search', 'streamable_http',
...
-- Dump completed on 2026-03-25 20:53:29

...
| [V2.1 退款验收报告](acceptance/v21-refund-20260812.md) | 本机 MySQL、HTTP 模拟渠道、重试与重启恢复结果 | 核对退款可靠性闭环时 |
...
| [退款生命周期 V2.1 升级脚本](dev-ops/mysql/sql/manual-upgrade-refund-lifecycle-v21.sql) | 为售后审核、异步退款、租约与重试增加字段和索引 | 完成备份后升级退款闭环时 |

...
- `mvn clean '-DskipTests=false' test`：通过，Core 48、Infrastructure 67、App 17。
...
- 本地代码门禁已通过：规范检查、脚本 9 项、runtime eval 5 项、Maven Core 48/Infrastructure 67/App 17，以及前端 typecheck、Vitest 31 项和 production build。

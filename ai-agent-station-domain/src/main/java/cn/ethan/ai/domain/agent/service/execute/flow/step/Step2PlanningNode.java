...
public class Step2PlanningNode extends AbstractExecuteSupport {
    ...
    private String getActualMcpToolsInfo() {
        ...
        try {
            toolsInfo.append("## 1. 小红书工具 (rednote)\n");
            toolsInfo.append("- **传输类型**: stdio\n");
            toolsInfo.append("- **核心功能**: 小红书内容搜索与发布\n");
            toolsInfo.append("- **主要工具函数**: rednote\n");
            toolsInfo.append("- **参数要求**: 待根据实际接口补充\n");
            toolsInfo.append("- **适用场景**: 社交内容获取、笔记发布\n\n");

            toolsInfo.append("## 2. 通知服务工具 (notify)\n");
            toolsInfo.append("- **传输类型**: stdio\n");
            toolsInfo.append("- **核心功能**: 发送通知消息\n");
            toolsInfo.append("- **主要工具函数**: notify\n");
            toolsInfo.append("- **参数要求**: 待根据实际接口补充\n");
            toolsInfo.append("- **适用场景**: 状态通知、结果反馈\n\n");

            toolsInfo.append("## 6. 百度搜索工具 (baidu-search)\n");
            toolsInfo.append("- **传输类型**: streamable_http\n");
            toolsInfo.append("- **服务端点**: https://qianfan.baidubce.com/v2/ai_search/mcp\n");
            toolsInfo.append("- **核心功能**: 百度搜索引擎检索\n");
            toolsInfo.append("- **主要工具函数**: baidu-search\n");
            toolsInfo.append("- **参数要求**: 待根据实际接口补充\n");
            toolsInfo.append("- **适用场景**: 技术资料搜索、信息获取\n\n");
        } catch (Exception e) {

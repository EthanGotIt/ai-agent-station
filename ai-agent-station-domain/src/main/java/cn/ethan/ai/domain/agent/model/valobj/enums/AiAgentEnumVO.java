...
public enum AiAgentEnumVO {
    ...
    AI_CLIENT_SYSTEM_PROMPT("提示词", "prompt", "ai_client_system_prompt_", "ai_client_system_prompt_data_list", ""),
    AI_CLIENT_TOOL_MCP("MCP工具", "tool_mcp", "ai_client_tool_mcp_", "ai_client_tool_mcp_data_list", ""),

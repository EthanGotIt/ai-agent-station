...
public abstract class AbstractExecuteSupport extends AbstractMultiThreadStrategyRouter<ExecuteCommandEntity, DefaultFlowAgentExecuteStrategyFactory.DynamicContext, String> {
    ...
    protected ChatClient getChatClientByClientId(DefaultFlowAgentExecuteStrategyFactory.DynamicContext dynamicContext, String clientId) {
    ...
    protected void sendStreamResult(DefaultFlowAgentExecuteStrategyFactory.DynamicContext dynamicContext,
    ...
    protected void sendCompleteResult(DefaultFlowAgentExecuteStrategyFactory.DynamicContext dynamicContext, String sessionId) {
        sendStreamResult(dynamicContext, AutoAgentExecuteResultEntity.createCompleteResult(sessionId));
    }

...
/**
 * 类型职责：映射只表达提问职责的 QuestionCard。
 *
 * @author ethan
 * @date 2026-08-27
 */
@TableName("AGENT_QUESTION_CARD")
public final class AgentQuestionCardEntity {
    ...
    public String getResumeTarget() { return resumeTarget; }
    public void setResumeTarget(String resumeTarget) { this.resumeTarget = resumeTarget; }
